from AIvsHumanTextClassification.entity.config_entity import ModelConfig
...
class BaseModel:
    ...
    def Create_Base_Model(self):
        try:
            ...
            model.add(keras.layers.Bidirectional(keras.layers.LSTM(units=128, return_sequences=False))) 
