...
from AIvsHumanTextClassification.entity.config_entity import DataPreprocessConfig
...
class DataPreprocessor(BaseEstimator, TransformerMixin):
    ...
    def _remove_stopwords_and_stem(self, X):
        ...
        try:
            ...
            for text in X:
                words = text.split()
                words = [self.ls.lemmatize(word) for word in words if word not in self.stop_words]
